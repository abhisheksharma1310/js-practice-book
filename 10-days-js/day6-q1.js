...
//     for(let i=1; i<=n; i++) {
//         for(let j=i+1; j<=n; j++){
//             const res = convertToBinary(i, n) & convertToBinary(j, n);
//             setArr.push(Number(res.toString(10)));
//         }
//     }
//     return setArr.sort((a,b) => b-a).find(el => el < k);
// }

// function convertToBinary(n, max) {
//     while(n.toString(2).length < max.toString(2).length) {
//         n = `0${n}`;
//     }
//     return n;
// }
